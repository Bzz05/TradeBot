...
model = None
app_config_loaded: Optional[dict] = None
...
async def startup_event():
    ...
    try:
        ...
        with open(CONFIG_PATH, 'r') as f:
            app_config_loaded = yaml.safe_load(f)
        ...
        model_filename = "ppo_trading_agent_best_val.pth"
        ...
        position_size_fractions = env_cfg.get('position_size_fractions', [0.125, 0.25])
        ...
        device_str = app_config_loaded.get('device', 'cpu')
